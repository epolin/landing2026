(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))t(a);new MutationObserver(a=>{for(const i of a)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function o(a){const i={};return a.integrity&&(i.integrity=a.integrity),a.referrerPolicy&&(i.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?i.credentials="include":a.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function t(a){if(a.ep)return;a.ep=!0;const i=o(a);fetch(a.href,i)}})();const r="/landing2026/assets/images/CentroComercial-CFdRI0UI.png",p="/landing2026/assets/images/Edificio-CD7cxfAJ.png",w="/landing2026/assets/images/Estadio-BkhwXy5f.png",C="/landing2026/assets/images/Aeropuerto-hbiOQfIB.png",b="/landing2026/assets/images/Parque-erMChgtg.png";class v{constructor(){this.map=null,this.markers={},this.basePath=this.getBasePath(),this.init()}getBasePath(){const e=window.location.hostname.includes("github.io"),o=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";return console.log("Detectando ambiente:",{hostname:window.location.hostname,isGitHubPages:e,isLocal:o,protocol:window.location.protocol,href:window.location.href}),e?"/landing2026":""}getAssetPath(e){return window.location.hostname.includes("github.io")?"/landing2026"+e:e}init(){this.updateCSSPaths(),this.initCountdown(),this.initContactForm(),this.initNavigation(),this.initAvailabilityAnimation(),this.initBasicAnimations(),this.initOpenStreetMap(),console.log("Copa Mundial de Fútbol Monterrey 2026 - Landing App iniciada correctamente con OpenStreetMap")}initOpenStreetMap(){if(typeof L>"u"){console.warn("Leaflet no está disponible, mostrando placeholder"),this.showMapPlaceholder();return}try{if(console.log("Inicializando OpenStreetMap Copa Mundial de Fútbol Monterrey 2026..."),!document.getElementById("map")){console.warn("Elemento del mapa no encontrado");return}this.map=L.map("map",{center:[25.6866,-100.3161],zoom:12,zoomControl:!0,attributionControl:!0}),L.tileLayer("https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png",{attribution:'© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors | Copa Mundial de Fútbol 2026',maxZoom:19,className:"mundial-map-tiles"}).addTo(this.map),this.addMundialLocations(),this.setupLocationInteractivity(),console.log("✅ Mapa OpenStreetMap Copa Mundial 2026 inicializado correctamente")}catch(e){console.error("Error inicializando OpenStreetMap:",e),this.showMapPlaceholder()}}addMundialLocations(){[{id:"arboleda",name:"Arboleda",position:[25.649714,-100.356173],description:"Centro comercial premium al aire libre con alta afluencia familiar y ambiente sofisticado.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"premium, aire libre, centro comercial, alta afluencia, familiar, San Pedro Garza García",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"puntovalle",name:"Punto Valle, The Town Center",position:[25.658751,-100.361623],description:"Centro comercial premium con excelente gastronomía y entretenimiento de primer nivel.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"centro comercial, premium, gastronomía, entretenimiento, premier, San Pedro Garza García",traffic:"Muy Alto",showInCards:!0,showInMap:!0},{id:"chroma",name:"Chroma San Pedro",position:[25.667833,-100.352369],description:"Centro comercial con arquitectura moderna, gastronomía y entretenimiento de alta calidad.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"centro comercial, gastronomía, entretenimiento, arquitectura moderna, alta afluencia, San Pedro Garza García",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"auriga",name:"Auriga San Pedro",position:[25.648843,-100.339116],description:"Centro comercial moderno enfocado en experiencias, gastronomía y entretenimiento.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"centro comercial, experiencias, gastronomía, entretenimiento, moderno, San Pedro Garza García",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"fiesta",name:"Plaza Fiesta San Agustín",position:[25.64893,-100.336166],description:"Centro comercial familiar con alta afluencia, entretenimiento y cercanía al estadio.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"centro comercial, alta afluencia, familiar, entretenimiento, cerca del estadio, San Pedro Garza García",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"metropolitan",name:"Metropolitan Center",position:[25.650381,-100.333596],description:"Centro comercial premium de uso mixto con gastronomía exclusiva y alta afluencia.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"centro comercial, premium, uso mixto, gastronomía, alta afluencia, San Pedro Garza García",traffic:"Muy Alto",showInCards:!0,showInMap:!0},{id:"fashion",name:"Fashion Drive",position:[25.651295,-100.335131],description:"Centro comercial moderno con gastronomía, alta afluencia y entretenimiento.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Pedro Garza García",tags:"centro comercial, moderno, gastronomía, alta afluencia, entretenimiento, San Pedro Garza García",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"galerias",name:"Galerías Valle Oriente",position:[25.638228,-100.313963],description:"Centro comercial familiar con gastronomía, entretenimiento y muy alta afluencia.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, familiar, gastronomía, entretenimiento, alta afluencia, Monterrey",traffic:"Muy Alto",showInCards:!0,showInMap:!0},{id:"citadel",name:"Plaza Citadel",position:[25.726138,-100.215214],description:"Centro comercial familiar con gastronomía, entretenimiento y fácil acceso.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Nicolás de los Garza",tags:"centro comercial, familiar, gastronomía, entretenimiento, accesible, San Nicolás de los Garza",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"serena",name:"Pueblo Serena",position:[25.576056,-100.24827],description:"Centro comercial al aire libre, familiar, pet friendly con gastronomía.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, aire libre, familiar, gastronomía, pet friendly, Monterrey",traffic:"Medio-Alto",showInCards:!0,showInMap:!0},{id:"anahuac",name:"Plaza Fiesta Anahuac",position:[25.742955,-100.313308],description:"Centro comercial familiar con gastronomía, entretenimiento y alta afluencia.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Nicolás de los Garza",tags:"centro comercial, familiar, gastronomía, entretenimiento, alta afluencia, San Nicolás de los Garza",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"ocampo",name:"Ocampo Corner",position:[25.666858,-100.320719],description:"Complejo de uso mixto moderno con gastronomía, tecnología y ubicación céntrica.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"uso mixto, moderno, gastronomía, tecnología, céntrico, Monterrey",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"mexico",name:"Plaza México",position:[25.667518,-100.313174],description:"Centro comercial histórico con productos artesanales, gastronomía y ubicación céntrica.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, histórico, artesanal, gastronomía, céntrico, Monterrey",traffic:"Medio",showInCards:!0,showInMap:!0},{id:"via02",name:"Plaza Via 02",position:[25.696587,-100.380189],description:"Centro comercial moderno familiar con gastronomía y entretenimiento.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, moderno, gastronomía, entretenimiento, familiar, Monterrey",traffic:"Medio-Alto",showInCards:!0,showInMap:!0},{id:"hierro",name:"Plaza Vía Puerta de Hierro",position:[25.744716,-100.421793],description:"Centro comercial moderno con gastronomía, entretenimiento y fácil acceso.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, moderno, gastronomía, entretenimiento, accesible, Monterrey",traffic:"Medio",showInCards:!0,showInMap:!0},{id:"lafe",name:"Paseo La Fe",position:[25.719691,-100.218991],description:"Centro comercial al aire libre, pet friendly con gastronomía y entretenimiento.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"San Nicolás de los Garza",tags:"centro comercial, aire libre, pet friendly, gastronomía, entretenimiento, San Nicolás de los Garza",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"tec",name:"Paseo Tec",position:[25.654433,-100.293758],description:"Centro comercial de uso mixto con gastronomía, entretenimiento y ubicación céntrica.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, uso mixto, gastronomía, entretenimiento, céntrico, Monterrey",traffic:"Alto",showInCards:!0,showInMap:!0},{id:"juarez",name:"Paseo Juárez",position:[25.650405,-100.112078],description:"Centro comercial familiar con gastronomía, entretenimiento y fácil acceso.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Ciudad Benito Juárez",tags:"centro comercial, familiar, gastronomía, entretenimiento, accesible, Ciudad Benito Juárez",traffic:"Medio",showInCards:!0,showInMap:!0},{id:"nuevosur",name:"Plaza Nuevo Sur",position:[25.653529,-100.275301],description:"Centro comercial al aire libre moderno con gastronomía y entretenimiento.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Monterrey",tags:"centro comercial, aire libre, gastronomía, entretenimiento, moderno, Monterrey",traffic:"Medio-Alto",showInCards:!0,showInMap:!0},{id:"molinete",name:"El Molinete",position:[25.662388,-100.149543],description:"Centro comercial al aire libre familiar con gastronomía y entretenimiento.",category:"Centro comercial",type:"centro-comercial",image:r,municipio:"Guadalupe",tags:"centro comercial, aire libre, familiar, gastronomía, entretenimiento, Guadalupe",traffic:"Medio",showInCards:!0,showInMap:!0},{id:"republica",name:"Torre República",position:[25.686054,-100.330094],description:"Edificio de uso mixto residencial moderno con amenidades y ubicación céntrica.",category:"Edificio",type:"edificio",image:p,municipio:"Monterrey",tags:"uso mixto, residencial, amenidades, céntrico, moderno, Monterrey",traffic:"Medio",showInCards:!0,showInMap:!0},{id:"citica",name:"Cítica",position:[25.669887,-100.334254],description:"Edificio de uso mixto con oficinas, gastronomía y ubicación céntrica.",category:"Edificio",type:"edificio",image:p,municipio:"Monterrey",tags:"uso mixto, residencial, oficinas, gastronomía, céntrico, Monterrey",traffic:"Medio",showInCards:!0,showInMap:!0},{id:"estadio",name:"Estadio Monterrey",position:[25.669079,-100.24437],description:"Estadio moderno con alta afluencia, sede oficial de partidos del Mundial 2026.",category:"Estadio",type:"estadio",image:w,municipio:"Guadalupe",tags:"estadio, deportivo, moderno, alta afluencia, cerca del estadio, Guadalupe",traffic:"Mundial",showInCards:!1,showInMap:!0,special:!0},{id:"aeropuerto",name:"Aeropuerto Internacional de Monterrey",position:[25.77462,-100.11158],description:"Aeropuerto internacional moderno, punto de entrada principal para visitantes del Mundial.",category:"Aeropuerto",type:"aeropuerto",image:C,municipio:"Apodaca",tags:"aeropuerto, internacional, moderno, alta afluencia, conectividad, Apodaca",traffic:"Internacional",showInCards:!1,showInMap:!0,special:!0},{id:"fanfestival",name:"Fan Festival (Parque Fundidora)",position:[25.67715,-100.28232],description:"Evento oficial al aire libre con alta afluencia, gastronomía y entretenimiento.",category:"Parque",type:"parque",image:b,municipio:"Monterrey",tags:"evento, aire libre, alta afluencia, gastronomía, entretenimiento, Monterrey",traffic:"Mundial",showInCards:!1,showInMap:!0,special:!0}].forEach(o=>{if(!o.showInMap)return;const t=L.divIcon({className:"custom-marker-icon",iconSize:[48,48],iconAnchor:[24,24],html:`
...
¡Gracias!`)}`;window.open(t,"_blank")}prefillFormFromURL(){const e=new URLSearchParams(window.location.search);["nombre","empresa","email","telefono"].forEach(t=>{const a=e.get(t),i=document.getElementById(t);a&&i&&(i.value=decodeURIComponent(a))})}trackUserInteraction(e,o={}){const t={timestamp:new Date().toISOString(),action:e,details:o,page:"Copa Mundial 2026 Landing",userAgent:navigator.userAgent,url:window.location.href};console.log("Interacción registrada:",t)}updateCSSPaths(){const e="/landing2026/";console.log("🔧 Actualizando CSS con Vite BASE_URL:",e);const o=e+"bg/HeroBG.png",t=e+"bg/BeneficiosBG.png",a=e+"bg/ReservaBG.png";console.log("🖼️ Rutas finales:",{heroBg:o,beneficiosBg:t,reservaBg:a});const i=document.createElement("style");i.textContent=`
    ...
    `,document.head.appendChild(i),console.log("✅ CSS dinámico aplicado correctamente con BASE_URL")}}const M=`
...
`,u=document.createElement("style");u.textContent=M;document.head.appendChild(u);let l=null;window.loadCalendly=function(){l&&(l.loadCalendly(),l.trackUserInteraction("calendly_opened",{source:"contact_section"}))};window.sendEmailBooking=function(){l&&(l.sendEmailBooking(),l.trackUserInteraction("email_booking",{source:"contact_section"}))};window.openWhatsAppBooking=function(){l&&(l.openWhatsAppBooking(),l.trackUserInteraction("whatsapp_booking",{source:"contact_section"}))};document.addEventListener("DOMContentLoaded",()=>{console.log("DOM cargado, inicializando Copa Mundial de Fútbol Monterrey 2026 con OpenStreetMap..."),l=new v,l.prefillFormFromURL()});
